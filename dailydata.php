...
<body>
	...
	<div class="dropdown" id="dropdown" style="float:right;display:none;">
        ...
        <div class="navigbar">
                <ul>
                    ...
                    <li><a class="nav-link active-navlink" href="#" >Daily Data</a></li>
 ...
 -->
        ...
        <p style="background-color: rgb(86, 175, 80);font-size: 5px;margin-bottom:5px;">.</p>
        <div style="float: left; width:50%;">
          <h1 style="font-weight: 700; color:rgb(153, 179, 105); margin:20px 1%; ">COVID-19 CASES IN INDIA</h1>
        </div>
        <form style="float:right; width:50%;padding: 20px;text-align: left;" onsubmit=" return searchfunc()" >
            <input type="text" name="search" class="searchbar" id="searchinp" placeholder="eg. 04 June">
        </form>
                            <!-- TABLE -->
    <div class="table-responsive" style="max-width: 98%; margin:10px auto;" >
    <table class="table table-dark table-bordered table-hover table-striped text-center" id="tbval">
    <tr>
      
      
      <th style="border: 2px solid rgb(131, 131, 131); color:rgb(192, 189, 189);"> DATE</th>
      <th style="border: 2px solid rgb(131, 131, 131);color:rgb(192, 189, 189);">TOTAL CONFORMED</th>
      <th style="border: 2px solid rgb(131, 131, 131);color:rgb(192, 189, 189);">TOTAL RECOVERED</th>
       <th style="border: 2px solid rgb(131, 131, 131);color:rgb(192, 189, 189);">TOTAL DEATHS</th>
       <th style="border: 2px solid rgb(131, 131, 131);color:rgb(192, 189, 189);">NEW CASES</th>
      <th style="border: 2px solid rgb(131, 131, 131);color:rgb(192, 189, 189);">NEW RECOVERED</th>
      <th style="border: 2px solid rgb(131, 131, 131);color:rgb(192, 189, 189);">DAILY DEATHS</th>
    ...
    $i=$statescount-1;
    ?>
    <p class="text-muted" style="margin:0px;">This data was last updated on: <?php echo $coronalive['statewise'][1]['lastupdatedtime']?></p>
    <?php
  while($i >= 0) {
    ...
    <tr id="<?php echo $coronalive['cases_time_series'][$i]['date']?>">
      <td style="background-color: rgb(100, 52, 100);font-weight: 600;color:rgb(235, 240, 168); border: 2px solid rgb(131, 131, 151);
 ">
        <?php echo $coronalive['cases_time_series'][$i]['date']?>
        
      </td>

      <td style="color: rgb(235, 161, 161); border: 2px solid rgb(107, 101, 101); font-weight: 700;">
        <?php echo $coronalive['cases_time_series'][$i]['totalconfirmed']?>
      </td>


      <td style="color: rgb(137, 250, 227); border: 2px solid rgb(107, 101, 101);font-weight: 700;">
        <?php echo $coronalive['cases_time_series'][$i]['totalrecovered']?>
      </td>


      <td style="border: 2px solid rgb(107, 101, 101);color: rgb(112, 235, 163);font-weight: 700;">
        <?php echo $coronalive['cases_time_series'][$i]['totaldeceased']?>
      </td>


      <td style="border: 2px solid rgb(107, 101, 101);color:rgb(197, 191, 236);font-weight: 700;">
        <?php echo $coronalive['cases_time_series'][$i]['dailyconfirmed']?>
      </td>

      <td style="border: 2px solid rgb(107, 101, 101);color: rgb(251, 144, 225);font-weight: 700;">
        <?php echo $coronalive['cases_time_series'][$i]['dailyrecovered']?>
      </td>

      <td style="border: 2px solid rgb(107, 101, 101);color: rgb(255, 252, 75);font-weight: 700;">
...
function searchfunc(){
    ...
    state = state + " " ;
    /* state = state[0]+state[1]+state[2]+state[3].toUpperCase() + state.slice(1)+ " " ; */ 
